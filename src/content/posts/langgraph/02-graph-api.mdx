...
> - **前置知识**：建议先阅读本系列 [LangGraph 入门](/posts/langgraph/01-intro)；熟悉 Python 与 `TypedDict` 更佳。
...
![输入输出状态与 OverallState 关系示意](./02-graph-api/langgraph-02-Graph%20API_img_2026-04-05-17-06-10.png)
...
![私有字段在 OverallState 中的传递示意](./02-graph-api/langgraph-02-Graph%20API_img_2026-04-05-17-07-30.png)
